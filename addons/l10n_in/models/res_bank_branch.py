# -*- coding: utf-8 -*-
"""
Ocean ERP - Indian Bank Branch Model
====================================

Bank branch model with Indian localization for kids clothing retail.
"""
...
class ResBankBranch(BaseModel, KidsClothingMixin):
    """Indian Bank Branch Model for Ocean ERP"""
    ...
    name = CharField(
        string='Branch Name',
        required=True,
        help='Name of the bank branch'
    )
    
    code = CharField(
        string='Branch Code',
        required=True,
        help='Code of the bank branch'
    )
    ...
    bank_id = Many2OneField(
        ...
        string='Bank',
        required=True,
        help='Bank this branch belongs to'
    )
    ...
    age_group = SelectionField(
        ...
        string='Age Group',
        help='Primary age group for the branch'
    )
    ...
    size = SelectionField(
        ...
        string='Size',
        help='Primary size for the branch'
    )
    ...
    season = SelectionField(
        ...
        string='Season',
        help='Primary season for the branch'
    )
    
    brand = CharField(
        string='Brand',
        help='Primary brand for the branch'
    )
    
    color = CharField(
        string='Color',
        help='Primary color for the branch'
    )
    ...
    def create(self, vals):
        ...
        return super(ResBankBranch, self).create(vals)
    ...
    def get_kids_clothing_branches(self, age_group=None, size=None, season=None, brand=None, color=None):
        """Get branches filtered by kids clothing criteria"""
        domain = [('active', '=', True)]
